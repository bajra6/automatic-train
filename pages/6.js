    ...
    return ( 
        <div style={{overflow:"hidden", margin:"-8px", maxHeight:"100vh"}}>
            ...
            <div style={{position:"absolute", top:"30%", width:"100vw", display:"flex", justifyContent:"space-evenly"}}>
                ...
                <div style={option===5?{display:"inline-block", borderRadius:"1rem", backgroundColor:"rgba(0, 0, 0, 0.5)", textAlign:"center", color:"white", fontSize:"1.5rem", border:"3px solid white"}:{display:"inline-block", borderRadius:"1rem", backgroundColor:"rgba(0, 0, 0, 0.5)", textAlign:"center", color:"white", fontSize:"1.5rem"}} onClick={() => selectOption(5)}>
                    <div>
                        <img src="img/potion3.png" style={{height:"200px"}}/>
                    </div>
                    <div>
